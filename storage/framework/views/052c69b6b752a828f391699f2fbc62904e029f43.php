        ...
        <div class="row">
          <div class="led">
              <?php $__currentLoopData = $points; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div>&nbsp;&nbsp;<?php echo e($item->player->country->name); ?> 
                       <img src="/images/flag/<?php echo e($item->player->country->flag); ?>" width="50">&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      
                       <?php echo e($item->player->lname); ?> <b><?php echo e($item->player->fname); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <img src="/images/items/<?php echo e($item->item->photo); ?>">  
                  </div>
                  
                  <div class="score"> &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php echo e(($item->d1 + $item->d2)/2 + ($item->d3 + $item->d4)/2); ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(calcExecution($item)); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e($item->l1 + $item->l2 + $item->t1); ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(totalScore($item)); ?>    <?php echo e(number_format($item->t1, 2)); ?>
